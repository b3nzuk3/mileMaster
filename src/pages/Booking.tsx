        ...
        <Card className="max-w-2xl mx-4 shadow-automotive">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Thank you for choosing MileMaster Auto Care. We've received your service request and 
              will contact you within 24 hours to confirm your appointment details.
            </p>
            <div className="bg-muted p-6 rounded-lg mb-8">
              <h3 className="font-bold text-foreground mb-4">Your Booking Details:</h3>
              <div className="space-y-2 text-left">
                <p><span className="font-semibold">Service:</span> {formData.service}</p>
                <p><span className="font-semibold">Date:</span> {date ? format(date, "PPP") : "TBD"}</p>
                <p><span className="font-semibold">Time:</span> {formData.timeSlot || "TBD"}</p>
                <p><span className="font-semibold">Vehicle:</span> {formData.vehicleYear} {formData.vehicleMake} {formData.vehicleModel}</p>
              </div>
            </div>
            <p className="text-muted-foreground mb-6">
              Questions? Call us at <span className="font-semibold text-primary">(555) 123-4567</span>
            </p>
    ...
    <div className="min-h-screen pt-20 bg-muted">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-foreground mb-4">Book Your Service</h1>
        ...
        <Card className="shadow-automotive">
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Vehicle Information */}
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-6">Vehicle Information</h3>
                <div className="grid md:grid-cols-3 gap-6">
                  <div>
                    <Label htmlFor="vehicleYear" className="text-base font-semibold">Year *</Label>
                    <Input
                      id="vehicleYear"
                  ...
                  <div>
                    <Label htmlFor="vehicleMake" className="text-base font-semibold">Make *</Label>
                    <Input
                      id="vehicleMake"
                  ...
                  <div>
                    <Label htmlFor="vehicleModel" className="text-base font-semibold">Model *</Label>
                    <Input
                      id="vehicleModel"
              ...
              {/* Service Details */}
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-6">Service Details</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <Label className="text-base font-semibold">Service Needed *</Label>
